...
::warning
Environment variable values are automatically cast to their JavaScript type using `devalue`. If you want a value to stay a string, wrap it in double quotes within your `.env` file (for example `NUXT_MY_VAR=""4848e0""`).
::
